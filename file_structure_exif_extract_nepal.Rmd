...
# these additional sub-folders (A/B pr 100/101 BTCF) are created automatically when there is more than 10,000 images in the SD card
...
# Creating unique file numbers - there were duplicates for files in different months and in a/b folders
